...
import {ProductDetailParamDataComponent} from './product-detail-param-data.component';
...
@NgModule({
    ...
    declarations: [ AppComponent, HomeComponent, ProductDetailParamDataComponent, _404Component ],
